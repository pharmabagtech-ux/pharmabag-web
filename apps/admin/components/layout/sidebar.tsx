...
import { LayoutDashboard, Users, Package, ClipboardList, BarChart3, Settings, LogOut, Shield, ChevronLeft, FolderTree, CreditCard, Banknote, Ticket, Bell, UserCog, FileSpreadsheet, Image, Gift, Layout, MessageSquare, PackagePlus, Newspaper, Globe, ArrowRightLeft } from "lucide-react";
...
const NAV = [
  ...
  { icon: Globe, label: "SEO Settings", href: "/seo-settings" },
  { icon: ArrowRightLeft, label: "Redirects", href: "/redirects" },
