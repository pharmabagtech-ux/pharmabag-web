  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-2 px-2 sm:px-4">
        <div className="max-w-[1400px] w-full mx-auto px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl backdrop-blur-xl bg-white/40 border border-white/40 shadow-[0_8px_32px_rgba(0,0,0,0.12)]">
