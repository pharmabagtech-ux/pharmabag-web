    ...
    <>
      <nav className="fixed bottom-0 lg:bottom-auto lg:top-4 left-0 right-0 z-40 flex justify-center pb-2 lg:pb-0 px-2 sm:px-[4vw]">
        <div className="relative w-[96vw] sm:w-[92vw] max-w-[1400px] mx-auto px-4 lg:px-8 py-2.5 lg:py-3.5 rounded-2xl bg-white shadow-xl flex items-center justify-between border border-gray-100/50">
            ...
            <div className="hidden lg:flex max-w-[700px] xl:max-w-[900px] min-w-0 relative group/nav h-full items-center">
              {/* Left Blur Mask */}
              ...
              <div className="w-full overflow-x-auto scroll-thin-hover flex h-full">
                <div className="flex items-center gap-3 xl:gap-5 whitespace-nowrap px-10">
                  <Link
                    href="/products"
            ...
            <div className="flex-1 flex items-center justify-end gap-2 sm:gap-4 z-10 min-w-[100px]">
              {/* ... existing actions ... */}
