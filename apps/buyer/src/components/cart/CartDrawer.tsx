                          ...
                          <div className="flex items-center gap-3 bg-gray-50 rounded-2xl px-3 py-1">
                            <button
                              onClick={() => {
                                ...
                                // Scheme products move a whole lot at a time, so
                                // the bag cannot walk a quantity off the boundary
                                // the product page put it on.
                            ...
                            <button
                              onClick={() => {
                                ...
                                const moq = item.moq || item.product?.moq || item.product?.minimumOrderQuantity || 1;
                                const lot = listingLotSize(item);
                                const next = stepQuantityByLot(item.quantity, 1, lot, moq, max);
